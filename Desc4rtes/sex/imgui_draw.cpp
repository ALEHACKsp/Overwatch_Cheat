...
void ImGui::StyleColorsClassic(ImGuiStyle* dst)
{
    ...
    colors[ImGuiCol_TitleBg] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_TitleBgActive] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_TitleBgCollapsed] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_MenuBarBg] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_ScrollbarBg] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_CheckMark] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_SliderGrab] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_SliderGrabActive] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_Button] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_ButtonHovered] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_ButtonActive] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_Header] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_HeaderActive] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_Separator] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_SeparatorHovered] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_SeparatorActive] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_ResizeGrip] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_ResizeGripActive] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_Tab] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_TabHovered] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    ...
    colors[ImGuiCol_PlotLines] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_PlotHistogram] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_TextSelectedBg] = ImVec4(2.00f, 0.49f, 0.70f, 1.00f);
    colors[ImGuiCol_DragDropTarget] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_NavHighlight] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_NavWindowingDimBg] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
    colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.07f, 0.07f, 0.07f, 1.00f);
}
